...
class Datatable:
    def __init__(self):
        self.map = {};
    def add(self, assigning_node):
        self.map[assigning_node.tok.value] = assigning_node.value;
    def get(self, getting_node):
        return self.map.get(getting_node.tok.value, "Variable Not Found");
    def __repr__(self):
        t = [];
